	...
	<table>
		...
		{ ?>
			<tr class="row">
				...
				<td><a href="menu-detail.php?id=<?php echo $data['Menu_ID']; ?>">View Detail</a> | <a
							href="edit-menu.php?id=<?php echo $data['Menu_ID']; ?>">Edit</a> | <a
							href="delete-menu.php?id=<?php echo $data['Menu_ID']; ?>">Delete</a></td>
			</tr>
		<?php }
		} ?>
	</table>
